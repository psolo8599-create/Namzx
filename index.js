...
// Configuration
const apikey = 'ptla_G17U7kwFjOW1q2M52CvVCJGH67usnqlNPnEehtnShkm';
const capikey = 'ptlc_cvE1ySM87DBTW2cUfURTEJRAL0XGtgti5lZoucZzS2h';
const domain = 'https://tithosting.hostsatoruu.biz.id/';
const nestid = '5';
const egg = '15';
const loc = '1';
...
const adminTelegramId = '2076952351';
...
app.post('/api/login', (req, res) => {
  ...
  if (username === 'namz' && password === 'namz123') {
